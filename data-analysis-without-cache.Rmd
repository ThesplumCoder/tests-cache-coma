...
```{r}
querie1_tbmenu_prod <- read.csv(file = "./data/events_statements_history_long_202412181352.csv")
querie1_tbmenu_local <- read.csv(file = "./data/events_statements_history_long_202412181703.csv")
querie1_tbusuario_local <- read.csv(file = "./data/query-events_statements_history_long_202412262137.csv")
```

```{r}
hist(querie1_tbusuario_local$TIMER_WAIT * 1e-12, 
     breaks = 20)
abline(v = 6806279000 * 1e-12)
abline(v = mean(querie1_tbusuario_local$TIMER_WAIT * 1e-12), col = "coral")
boxplot(querie1_tbusuario_local$TIMER_WAIT * 1e-12)
summary(querie1_tbusuario_local$TIMER_WAIT * 1e-12)
```
